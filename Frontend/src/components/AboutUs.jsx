            ...
            <div className="lg:pr-4">
              <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
                <p>
                  ...
                  consectetur unde vitae quisquam enim tempore quae rerum
                  mollitia rem ea quo quas, saepe quasi!
                </p>
                <ul role="list" className="mt-8 space-y-8 text-gray-600">
                  <li className="flex gap-x-3">
                    ...
                    <span>
                      ...
                      Lorem ipsum dolor sit amet consectetur adipisicing elit.
                      At officia, itaque repellat sunt nihil nisi explicabo
                      provident ipsum reiciendis exercitationem!
                    </span>
                  </li>
                  <li className="flex gap-x-3">
                    <LockClosedIcon
                  ...
                  <li className="flex gap-x-3">
                    ...
                    <span>
                      ...
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                      Doloremque tempora sint ipsum amet voluptate ipsam ea
                      blanditiis perferendis. Molestiae, impedit?
                    </span>
                  </li>
                </ul>
                <p className="mt-8">
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
          <div class="mx-auto mb-8 max-w-screen-sm lg:mb-16">
            ...
            <p class="font-light text-gray-500 sm:text-xl dark:text-gray-400">
              ...
              vero omnis obcaecati ad ab fuga, libero rerum velit deleniti
              molestiae numquam nam? Quae, voluptas.
            </p>
          </div>
